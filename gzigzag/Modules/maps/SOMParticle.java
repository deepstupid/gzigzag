...
// som particle, implements ZZMap.Particle interface

package org.gzigzag.map;
import org.gzigzag.*;
import java.util.*;

public class SOMParticle implements ZZMap.Particle {
    private float x, y;
    private int[] q;
    ...
    public SOMParticle(int id, ZZCell c, float x, float y, int[] q) {
    ...
    public SOMParticle(int id, ZZCell c, int[] q) {
	this.q = new int[q.length];
	System.arraycopy(q, 0, this.q, 0, q.length);
